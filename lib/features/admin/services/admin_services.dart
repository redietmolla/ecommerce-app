...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dvlwufnmq', 'xwqyr1l1');
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales(category: 'Fruit', value: response['FruitEarnings']),
            Sales(category: 'Cake', value: response['CakeEarnings']),
            Sales(category: 'Vegetable', value: response['VegetableEarnings']),
          ];
        },
      );
    } catch (e) {
